...
const steps = [
  ...
  { id: 3, title: "Chain ID & Token Symbol", phase: "CREATE" },
  ...
  { id: 8, title: "Deploy VMC & Initialize VMC", phase: "DEPLOY" },
];
...
const WizardSidebar = ({ currentStep = 1 }) => {
  ...
  return (
    <aside className="w-64 bg-[#0a0f1d] border-r border-[#1e293b] flex flex-col h-full overflow-y-auto">
      <div className="p-2">
        <div className="text-[8px] font-bold text-gray-500 uppercase tracking-widest mb-4">
          Phase 1 — Create
        </div>
        ...
        <div className="text-[8px] font-bold text-gray-500 uppercase tracking-widest mt-8 mb-4">
          Phase 2 — Deploy
        </div>
        <div className="space-y-1">
